...

{
...

	{
		...
		htmlReporter.config().setDocumentTitle("Incedo Automation Report"); // Title of report

		htmlReporter.config().setReportName("Incedo Functional Automation Testing Report"); // name of the report
